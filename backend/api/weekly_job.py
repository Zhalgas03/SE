      ...
      <table width="620" cellpadding="0" cellspacing="0" style="padding:10px 28px 0 28px;font-family:Arial,Helvetica,sans-serif;">
        <tr>
          <td style="font-size:12px;color:#9ca3af;">
            ...
            <a href="{{ base_url }}/profile" style="color:#9ca3af;">Turn off weekly emails</a>
          </td>
        </tr>
      </table>
    </td>
...
def _build_offer_links():
    ...
    # Простой текстовый вариант (для plaintext-клиентов)
    text = (
        ...
        f"Unsubscribe: {base_url}/profile\n"
    )

    # ВАЖНО: вернуть именно 6 значений
