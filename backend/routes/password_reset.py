...
def forgot_password():
    ...
    print("📥 [forgot-password] Incoming request for email:", email)

    if not email:
        print("⚠️ Email is missing in request")
    ...
    try:
        ...
        with conn.cursor(cursor_factory=RealDictCursor) as cur:
            ...
            print("✅ Email found, sending reset code...")
            ...
            conn.commit()
            print("💾 Code saved to DB for", email)
